Shader "Custom/RenderOcludedOrNot"
{
    Properties
    {
...
//             ENDCG
        ...
        Pass
        {
            ...
            Stencil {
                Ref [_StencilRef]      // declare the desired stencil value
                Comp LEqual             // only render when stencil value is equal to the desired
            }
        ...
        Stencil {
            Ref [_StencilRef]      // declare the desired stencil value
            Comp Greater             // only render when stencil value is equal to the desired
        }
